...
describe('<Form />', () => {
    const app = (fields: FieldType[], onSubmit: any = () => null, getComponent?: (props: CustomComponentProps) => React.ReactNode) => {
        type Props = {
            id: string;
            fields: FieldType[];
        ...
        const App: React.FC<Props> = (props) => {
            ...
            return (
                <Form onFieldsChange={onFieldsChange} {...props} fields={stateFields} />
            );
        };
    ...
    it('should render and submit customComponents', () => {
        ...
        const customComponents = (props: CustomComponentProps) => (props.type === 'text') ? (
            <input
                name="testNameInput"
    ...
    it('should render custom group component', () => {
        ...
        const customComponents = (props: CustomComponentProps) => (props.type === 'group') ? (
            <div>
